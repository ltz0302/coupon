...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='路径信息表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='角色路径映射表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户角色关系映射表';